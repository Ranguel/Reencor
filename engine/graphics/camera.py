...
from engine.gameplay.common_functions import rotatate_vector, normalize_length
...
class Camera:
    def __init__(self, aspect, smoothness=0.1):
        self.type = "camera"
    ...
    def get_focus_point(self, active_players=[], active_stages=[]):
        ...
        if self.path:
            ...
            cx, cy, cz = obj.position + rotatate_vector(
                obj.rotation,
